...
All .canvas files in this folder can be found as .md text files in the Md folder.

If you are interested, I encourage you to open the .canvas files in Obsidian to open my annotations as they were originally intended to be viwed.
